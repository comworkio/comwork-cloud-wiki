...
```shell
curl -L "https://gitlab.comwork.io/oss/cwc/cwc/-/releases/v1.10.11/downloads/cwc_1.10.11_windows_amd64.zip" -o "cwc_cli.zip"
unzip cwc_cli.zip 
cd 
cwc.exe
```
...
```shell
curl -L "https://gitlab.comwork.io/oss/cwc/cwc/-/releases/v1.10.11/downloads/cwc_1.10.11_windows_arm64.zip" -o "cwc_cli.zip"
unzip cwc_cli.zip 
cd cwc_cli
cwc.exe
```
